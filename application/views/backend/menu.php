<nav>
    <ul class="nav">
        ...
        <li><a href="<?= base_url('control_panel/messages') ?>"><i class="lnr lnr-user"></i> <span>Messages</span></a>
        </li>
        <li>
        ...
        <li>
            ...
            <div id="AM" class="collapse ">
                <ul class="nav">
                    <li><a href="<?php echo base_url('backend/ads_info'); ?>" target=""><i class="fa fa-angle-double-right"></i>Show Ads</a></li>
                </ul>
            </div>
        </li>
        <li>
